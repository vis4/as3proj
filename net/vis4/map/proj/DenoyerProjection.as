...
package net.vis4.map.proj 
{
	...
	public class DenoyerProjection extends Projection
	{
		...
		public static const C0:Number = 0.95;
		public static const C1:Number = -.08333333333333333333;
		public static const C3:Number = 0.00166666666666666666;
		public static const D1:Number = 0.9;
		public static const D5:Number = 0.03;
		
		override public function project(lplam:Number, lpphi:Number, out:Point):Point 
		{
			out.y = lpphi;
			out.x = lplam;
			var aphi:Number = Math.abs(lplam);
		...
		override public function get shortName():String { return "Denoyer"; }
