...
package net.vis4.map.proj 
{
	...
	public class RobinsonProjection extends PseudoCylindricalProjection
	{
		...
		private const NODES:int = 18;
		private static const FXC:Number = 0.8487;
		private static const FYC:Number = 1.3523;
		private static const C1:Number = 11.45915590261646417544;
		private static const RC1:Number = 0.08726646259971647884;
		private static const ONEEPS:Number = 1.000001;
		private static const EPS:Number = 1e-8;		
		
		public function RobinsonProjection() 
		{
			
		}

		private function poly(array:Array, offset:int, z:Number):Number {
		...
		override public function projectInverse(x:Number, y:Number, lp:Point):Point 
		{
			...
			if (lp.y >= 1.0) {
				...
				var Tc0:Number = Y[i];
				var Tc1:Number = Y[i+1];
				var Tc2:Number = Y[i+2];
				var Tc3:Number = Y[i+3];
