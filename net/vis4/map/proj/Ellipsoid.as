...
package net.vis4.map.proj 
{
	...
	public class Ellipsoid
	{
		...
		public var equatorRadius:Number = 1.0;
		public var poleRadius:Number = 1.0;
		public var eccentricity:Number = 1.0;
		public var eccentricity2:Number = 1.0;

		// From: USGS PROJ package.
		public static const SPHERE:Ellipsoid = new Ellipsoid("sphere", 6371008.7714, 6371008.7714, 0.0, "Sphere");
		public static const BESSEL:Ellipsoid = new Ellipsoid("bessel", 6377397.155, 0.0, 299.1528128, "Bessel 1841");
		public static const CLARKE_1866:Ellipsoid = new Ellipsoid("clrk66", 6378206.4, 6356583.8, 0.0, "Clarke 1866");
		public static const CLARKE_1880:Ellipsoid = new Ellipsoid("clrk80", 6378249.145, 0.0, 293.4663, "Clarke 1880 mod.");
		public static const AIRY:Ellipsoid = new Ellipsoid("airy", 6377563.396, 6356256.910, 0.0, "Airy 1830");
		public static const WGS_1960:Ellipsoid = new Ellipsoid("WGS60", 6378165.0, 0.0, 298.3, "WGS 60");
		public static const WGS_1966:Ellipsoid = new Ellipsoid("WGS66", 6378145.0, 0.0, 298.25, "WGS 66");
		public static const WGS_1972:Ellipsoid = new Ellipsoid("WGS72", 6378135.0, 0.0, 298.26, "WGS 72");
		public static const WGS_1984:Ellipsoid = new Ellipsoid("WGS84", 6378137.0, 0.0, 298.257223563, "WGS 84");
		public static const KRASOVSKY:Ellipsoid = new Ellipsoid("krass", 6378245.0, 298.3, 0.0, "Krassovsky, 1942");
		public static const EVEREST:Ellipsoid = new Ellipsoid("evrst30", 6377276.345, 0.0, 300.8017, "Everest 1830");
		public static const INTERNATIONAL_1967:Ellipsoid = new Ellipsoid("new_intl", 6378157.5, 6356772.2, 0.0, "New International 1967");
		public static const GRS_1980:Ellipsoid = new Ellipsoid("GRS80", 6378137.0, 0.0, 298.257222101, "GRS 1980 (IUGG, 1980)");

		public static const AUSTRALIAN:Ellipsoid = new Ellipsoid("australian", 6378160.0, 6356774.7, 298.25, "Australian");
		
		public static const ellipsoids:Array = [
			SPHERE,
		...
		public function Ellipsoid(shortName:String = '', equatorRadius:Number = 0, poleRadius:Number = 0, reciprocalFlattening:Number = 0, name:String = '') {
			this.shortName = shortName;
			this.name = name;
			this.equatorRadius = equatorRadius;
			this.poleRadius = poleRadius;
			if (reciprocalFlattening != 0) {
				var flattening:Number = 1.0 / reciprocalFlattening;
				var f:Number = flattening;
		...
		public static function altConstructor(shortName:String, equatorRadius:Number, eccentricity2:Number, name:String):Ellipsoid
		{
		...
		public function setEquatorRadius(equatorRadius:Number):void {
			this.equatorRadius = equatorRadius;
		}
		...
		public function setEccentricitySquared(eccentricity2:Number):void {
			this.eccentricity2 = eccentricity2;
			poleRadius = equatorRadius * Math.sqrt(1.0 - eccentricity2);
			eccentricity = Math.sqrt(eccentricity2);
		}

		public function getEccentricitySquared():Number {
